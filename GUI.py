...
lblWarning = Label(f00, bg='gray54', fg='white', wraplength=400, text="The clipboard will be cleaned after the "
                                                                      "programme quit.")
lblWarning.place(relx=0.5, rely=0.9, anchor='n')
# f1
...
btnCopy = Button(f00, command=lambda: main_v201.copy_clb(root01, eth))
